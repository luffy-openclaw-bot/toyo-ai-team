#!/usr/bin/env python3
"""
Toyo Security AI Team - CrewAI Demo (LiteLLM + Ollama Cloud)
為 Toyo Security 創建的 AI 員工團隊
使用 LiteLLM + Ollama Cloud API (OpenAI 兼容模式)
"""
...
print("=" * 60)
print("🤖 Toyo Security AI Team - CrewAI Demo (LiteLLM + Ollama Cloud)")
print("=" * 60)
print()
...
# 測試 API 連接
print("📡 測試 Ollama Cloud API...")
try:
    response = completion(
        model="openai/gemma4:31b-cloud",  # 使用 openai/ 前綴
        messages=[{"role": "user", "content": "用廣東話講：你好"}],
        api_base="https://ollama.com/v1",
        api_key="24eb99cd231348d28cab9f2f6c5fe656.y3hVb_bR0H8eNh4IUKmX9sSh",
        max_tokens=30
    )
    content = response.choices[0].message.content
    print(f"✅ API 連接成功！")
    print(f"   回應：{content[:50]}...")
...
with open('monthly-report.txt', 'w', encoding='utf-8') as f:
    f.write("=" * 60 + "\n")
    f.write("Toyo Security 月度保安報告 (2026 年 4 月)\n")
    f.write("Generated by CrewAI + LiteLLM + Ollama Cloud\n")
    f.write("=" * 60 + "\n\n")
    f.write(str(result))

print("\n💾 報告已保存到：monthly-report.txt")
